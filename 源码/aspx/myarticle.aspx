<%@ Page Title="" Language="C#" MasterPageFile="~/aspx/MasterPage.master" AutoEventWireup="true" CodeFile="myarticle.aspx.cs" Inherits="aspx_myarticle" %>
...
<p>
             <asp:GridView ID="GridView1" runat="server" AllowPaging="True" DataKeyNames="articleid"
                        ...
                        <asp:SqlDataSource ID="SqlDataSource1" runat="server"                          
                            ...
                            SelectCommand="SELECT [article], [author], [replynum], [latest], [seenum],[articleid] FROM [forum_article] WHERE ([author] = @author) order by articleid desc" 
                            ...
                            <SelectParameters>
                                <asp:SessionParameter Name="author" SessionField="author" Type="String" />
                            </SelectParameters>
                            <UpdateParameters>
