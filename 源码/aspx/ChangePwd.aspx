<%@ Page Title="" Language="C#" MasterPageFile="~/aspx/MasterPage.master" AutoEventWireup="true" CodeFile="ChangePwd.aspx.cs" Inherits="aspx_ChangePwd" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="my_div" runat="Server">
    <div class="login" style="padding: 50px 0 0 0">
        <img src="../images/logo_changepwd.gif" alt="97share" />
    </div>
